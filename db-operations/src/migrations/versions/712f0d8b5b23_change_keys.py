...
def upgrade() -> None:
    ...
    op.add_column('acto-clinico', sa.Column('estado', src.sql_models.types.Varchar(length=16), nullable=True))
    ...
    op.add_column('acto-clinico', sa.Column('ns', src.sql_models.types.Varchar(length=6), nullable=True))
    op.add_column('acto-clinico', sa.Column('tipo', src.sql_models.types.Varchar(length=17), nullable=True))
