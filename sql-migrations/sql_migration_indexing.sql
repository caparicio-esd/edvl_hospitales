...
ALTER TABLE `paciente` 
	MODIFY NHC VARCHAR(8) NOT NULL,
    MODIFY POSTALCODE VARCHAR(12) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `resultados_peticiones` SELECT * FROM `original__resultados_peticiones` LIMIT 0 1000
ALTER TABLE `resultados_peticiones` 
    ...
    MODIFY VALOR_TEXTO VARCHAR(64),
    MODIFY VALOR_ESTANDAR VARCHAR(64),
